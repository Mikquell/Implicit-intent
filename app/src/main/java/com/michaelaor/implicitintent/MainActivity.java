package com.michaelaor.implicitintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tampilKalkulatorOld(View view) {
        try {
    ...
    public void tampilSound(View view) {
        Intent souondIntent = new Intent(Settings.ACTION_SOUND_SETTINGS);
        startActivity(souondIntent);
    }

    public void tampilAirplane(View view){
        Intent soundIntent = new Intent(Settings.ACTION_AIRPLANE_MODE_SETTINGS);
    ...
    public void tampilKalkulator(View view){
        ...
        if (item_size >= 1)
        {
            ...
            {
                Toast.makeText(getApplicationContext(),"Tidak ditemukan alikasi kalkulator", Toast.LENGTH_SHORT);
            }
